...
const Navbar = () => {
  ...
  const navOptions = (
    <>
      ...
      <li>
        <NavLink className={navLinkClass} to='/recommend'>
          Recommend
        </NavLink>
      </li>
      <li>
      ...
      {user ? (
        <li>
          <NavLink className={navLinkClass} to='/itinerary'>
            Itinerary
          </NavLink>
        </li>
      ) : null}
      <li>
        <NavLink className={navLinkClass} to={user ? "/userpage" : "/login"}>
          {user ? "Account" : "Login"}
        </NavLink>
      </li>
    </>
    ...
    <>
      <div
        ...
        <div className='navbar-end mr-12 mx-auto gap-x-7'>
          ...
          {user ? (
            <button
              className='btn w-24 md:w-32 btn-outline text-white'
              onClick={logOut}>
              Logout
            </button>
          ) : (
